...
async def test_drone(drone_id: int, system_address: str, port: int, delay: float, xbee_port: str, camera: bool) -> None:
    """
    ...
    try:
        ...
        swarm_drone = SwarmDiscovery(xbee_port=xbee_port, camera=camera)  # Adjust port as needed
